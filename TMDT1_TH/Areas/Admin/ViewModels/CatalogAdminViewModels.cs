...
{
    public IReadOnlyList<CategoryRow> Items { get; init; } = Array.Empty<CategoryRow>();
    public CategoryFormViewModel Form { get; init; } = new();
    public IReadOnlyList<SelectListItem> ParentOptions { get; init; } = Array.Empty<SelectListItem>();
...
{
    public IReadOnlyList<BrandRow> Items { get; init; } = Array.Empty<BrandRow>();
